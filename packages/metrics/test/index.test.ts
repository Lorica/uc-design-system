...
describe('Metrics', () => {
  ...
  describe('initialize()', () => {
    ...
    it('calls boostrap functions', () => {
      ...
      const bootstrapGoogleAnalytics = jest.spyOn(
        Metrics,
  ...
  describe('bootstrapNewRelic()', () => {
    it('sets newrelic attributes', () => {
      ...
      expect(global.newrelic.setCustomAttribute).toHaveBeenCalledWith(
        'user-id',
        'N/A'
      )
      expect(global.newrelic.setCustomAttribute).toHaveBeenCalledWith(
  ...
  describe('bootstrapSentry()', () => {
    ...
    it('configures sentry', () => {
      ...
      expect(init).toHaveBeenCalledWith(
        expect.objectContaining({
          dsn: 'http://123456@localhost/uc-design-system',
          environment: 'test',
          ignoreErrors: ['APIError'],
        })
      )
    ...
    it('configures sentry with a custom DSN and options', () => {
      Metrics.settings.sentry = {
        dsn: 'http://123456@localhost/proxy/sentry/uc-design-system',
        sampleRate: 0,
      }
      Metrics.bootstrapSentry()
