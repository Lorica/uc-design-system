...
describe('<Autocomplete />', () => {
  ...
  describe('handleInputKeyDown()', () => {
    ...
    it('supports `ArrowDown` event and sets state', () => {
      ...
      wrapper
        .find(BaseInput)
        .simulate('keydown', { key: 'ArrowDown', preventDefault: jest.fn() })
    ...
    it('supports `ArrowUp` event and sets state', () => {
      ...
      wrapper
        .find(BaseInput)
        .simulate('keydown', { key: 'ArrowUp', preventDefault: jest.fn() })
  ...
  describe('handleSelect()', () => {
    it('calls `onSelectItem` prop with found item', () => {
      ...
      setTimeout(
        () => expect(spy).toHaveBeenCalledWith({ value: 'foo', name: 'Foo' }),
        0
      )
    })
  ...
  describe('renderNoResults()', () => {
    ...
    it('renders a message by default', () => {
      ...
      expect(row.find(Text).prop('children')).toEqual(
        <T k="uc-design-system.common.noResults" phrase="No results found." />
      )
    })
