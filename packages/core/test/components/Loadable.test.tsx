...
describe('<Loadable />', () => {
  ...
  it('sets `mounted` state', () => {
    const wrapper = shallow<Loadable>(
      <Loadable component={importFunc} delay={300} />
    )
  ...
  describe('renderComponent()', () => {
    ...
    it('passes children to the imported component', () => {
      const wrapper = shallow<Loadable>(
        <Loadable component={importFunc}>Child</Loadable>
      )
    ...
    it('passes custom props to the imported component', () => {
      const wrapper = shallow<Loadable>(
        <Loadable component={importFunc} customProp="abc" />
      )
  ...
  describe('renderError()', () => {
    ...
    it('renders null if `noError` is true', () => {
      const wrapper = shallow<Loadable>(
        <Loadable noError component={importFunc} />
      )
    ...
    it('supports a render function with `error`', () => {
      ...
      const wrapper = shallow<Loadable>(
        <Loadable component={importFunc} error={renderFunc} />
      )
  ...
  describe('renderLoading()', () => {
    it('renders null if `noLoading` is true', () => {
      const wrapper = shallow<Loadable>(
        <Loadable noLoading component={importFunc} />
      )
