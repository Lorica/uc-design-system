...
describe('<FormActions />', () => {
  ...
  it('can change button text', () => {
    const wrapper = shallowWithStyles(
      <FormActions cancelText="Close" continueText="Send" />
    )
  ...
  it('disables buttons while processing', () => {
    ...
    wrapper
      .find(Button)
      .forEach((button) =>
        expect(button.prop('disabled') || button.prop('loading')).toBeTruthy()
      )
  })

  it('shows processing text while processing', () => {
    const wrapper = shallowWithStyles(
      <FormActions processing processingText="Sending" />
    )
  ...
  it('has small buttons when small', () => {
    ...
    wrapper
      .find(Button)
      .forEach((button) => expect(button.prop('small')).toBeTruthy())
  })
  ...
  it('does not habe small buttons when not small', () => {
    ...
    wrapper
      .find(Button)
      .forEach((button) => expect(button.prop('small')).toBeFalsy())
  })
