...
import IconStarFull from '@usercentric/uc-design-system-icons/lib/interface/IconStarFull';
import IconStarHalf from '@usercentric/uc-design-system-icons/lib/interface/IconStarHalf';
