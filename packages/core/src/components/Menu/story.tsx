...
import IconUser from '@lorica/uc-design-systemsign-systemsign-system-icons/lib/general/IconUser';
import IconSettings from '@lorica/uc-design-systemsign-systemsign-system-icons/lib/interface/IconSettings';
import IconKey from '@lorica/uc-design-systemsign-systemsign-system-icons/lib/interface/IconKey';
...
export function withLinksIcons1EmAndTips() {
  return (
    <Menu accessibilityLabel="User menu">
      <Item openInNewWindow icon={<IconUser decorative />} href="https://github.com/lorica/uc-design-systemsign-systemsign-system">
        Profile
      </Item>
      <Item
        openInNewWindow
        icon={<IconSettings decorative />}
        href="https://github.com/lorica/uc-design-systemsign-systemsign-system"
      >
        Settings
      </Item>
      <Item
