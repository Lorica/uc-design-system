...
import IconCaretLeft from '@lorica/uc-design-systemsign-system-icons/lib/interface/IconCaretLeft'
import IconCaretRight from '@lorica/uc-design-systemsign-system-icons/lib/interface/IconCaretRight'
