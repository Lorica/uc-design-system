...
import IconStarFull from '@lorica/uc-design-system-icons/lib/interface/IconStarFull';
import IconStarHalf from '@lorica/uc-design-system-icons/lib/interface/IconStarHalf';
