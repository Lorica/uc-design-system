...
import IconCheckAlt from '@usercentric/uc-design-system-icons/lib/interface/IconCheckAlt';
import IconClose from '@usercentric/uc-design-system-icons/lib/interface/IconClose';
import IconError from '@usercentric/uc-design-system-icons/lib/interface/IconError';
import IconInfo from '@usercentric/uc-design-system-icons/lib/interface/IconInfo';
import IconWarning from '@usercentric/uc-design-system-icons/lib/interface/IconWarning';
