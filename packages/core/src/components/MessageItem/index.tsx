...
function MessageItem({
      ...
      <>
        ...
        <div className={cx(styles.profileBadge)}>
          <ProfilePhoto
            ...
            size={2}
            title={T.phrase('uc-design-system.message.photoLabel', 'Profile photo badge')}
          />
        </div>
      </>
    ) : (
  ...
  const timestamp = source
    ? T.phrase('uc-design-system.message.source', '%{time} via %{source}', {
          ...
          <Spacing bottom={0.5}>
            ...
            {email && (
              <Text small muted>
                <T
                  html
                  k="uc-design-system.message.fromUser"
                  phrase="From: %{email}"
                  email={email}
                />
              </Text>
