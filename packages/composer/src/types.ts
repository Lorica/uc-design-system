...
export type Context = {
  ...
  setData: (
    name: string,
    value: DataValue | ((prevVaue: DataValue) => DataValue)
  ) => void
...
export type ReadableContext = Readonly<
  Pick<Context, 'data' | 'id' | 'menu' | 'mode'>
>
...
export type ProofreaderLoader = (
  params: ProofreaderParams
) => Promise<ProofreadConfig[]>
