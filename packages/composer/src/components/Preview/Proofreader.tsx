...
import ControlBar from '@usercentric/uc-design-system/lib/components/Proofreader/ControlBar'
import Renderer, {
  RendererProps,
} from '@usercentric/uc-design-system/lib/components/Proofreader/Renderer'
import { checkForAirbnbErrors } from '@usercentric/uc-design-system/lib/components/Proofreader/helpers'
import { NO_LOCALE } from '@usercentric/uc-design-system/lib/components/Proofreader/constants'
import { DEFAULT_LOCALE } from '@usercentric/uc-design-system/lib/constants'
    ...
    >
      ...
      {errorPosition && selectedError && (
        <Dropdown
          ...
          visible
          zIndex={5}
          onClickOutside={handleUnselectError}
        >
