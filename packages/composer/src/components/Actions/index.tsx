...
import ItemMenu, { Item, Row, Separator } from '@usercentric/uc-design-system/lib/components/Menu';
...
export default function Actions({ actions, endAlign, noWritingModes }: ActionsProps) {
  ...
  return (
    <Menu borderless startAlign={!endAlign} endAlign={endAlign} name={MENU_ACTIONS} width={215}>
      <ItemMenu
        overflow
        accessibilityLabel={T.phrase('uc-design-system.composer.actions.label', 'Actions menu')}
