  ...
  return (
    <>
      <Hotkey
        ...
        label={T.phrase('uc-design-system.composer.shortcuts.hotkey.toOpen', 'to shortcuts')}
      ...
      <Hotkey
        ...
        label={T.phrase('uc-design-system.composer.shortcuts.hotkey.moveUp', 'up')}
        onRun={moveUp}
      />
      ...
      <Hotkey
        ...
        label={T.phrase('uc-design-system.composer.shortcuts.hotkey.moveDown', 'down')}
        onRun={moveDown}
      />
      ...
      <Hotkey
        ...
        condition={activeWhenShortcutsMenuOpen}
        name="selectShortcut"
        label={T.phrase('uc-design-system.composer.shortcuts.hotkey.toSelect', 'to select')}
      ...
      <Menu
        centerAlign
        name={MENU_SHORTCUTS}
        title={<T k="uc-design-system.composer.shortcuts.title" phrase="Shortcuts" />}
      >
        <SelectList
          noResults={
            <T
