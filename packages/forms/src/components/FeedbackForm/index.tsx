...
> {
  ...
  validate(value: string) {
    if (!value) {
      throw new Error(T.phrase('uc-design-system.form.fieldRequired', 'This field is required.'));
    }
  }
    ...
    return (
      <Form onSubmit={this.handleSubmit} onStateUpdate={this.handleStateUpdate}>
            ...
            {(RadioButton) => (
              <div>
                <RadioButton
                  noSpacing
                  value="bug"
                  label={<T k="uc-design-system.form.feedback.reportBug" phrase="Report a bug" />}
                />
        ...
        <Select
          ...
          placeholder={T.phrase('uc-design-system.form.feedback.selectFeature', 'Select a feature')}
          validator={this.validate}
        >
        ...
        <TextArea
          name="feedback"
          label={
            <T k="uc-design-system.form.feedback.moreMessage" phrase="Tell us a little bit more" />
          }
          placeholder={
            data.type === 'bug'
              ? T.phrase(
        ...
        <FormActions
          continueText={<T k="uc-design-system.form.feedback.send" phrase="Send Feedback" />}
          processingText={<T k="uc-design-system.form.feedback.sending" phrase="Sending…" />}
          processing={loading}
          onCancel={onCancel}
