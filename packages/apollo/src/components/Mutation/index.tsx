...
export type MutationProps<Data, Vars> = Omit<
  MutationComponentOptions<Data, Vars>,
  'client'
> & {
  /**
...
> extends React.Component<MutationProps<Data, Vars>> {
  static defaultProps = {
  ...
  private handleRender = (
    mutator: MutationFunction<Data, Vars>,
    ...
    if (
      result.error &&
      (!this.props.ignoreGraphQLErrors || result.error.networkError)
    ) {
